...
NAND_IMG = limg("./asset/gates/nand.png").convert_alpha()
NOR_IMG = limg("./asset/gates/nor.png").convert_alpha()
XNOR_IMG = limg("./asset/gates/xnor.png").convert_alpha()
XOR_IMG = limg("./asset/gates/xor.png").convert_alpha()
